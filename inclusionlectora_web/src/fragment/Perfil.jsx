                            ...
                            <article className="card" aria-labelledby="info-usuario-titulo">
                                <div className="card-body">
                                    ...
                                    <figure className="d-flex flex-column align-items-center text-center">
                                        <img
                                            src={usuario?.user?.foto ? `${URLBASE}/images/users/${usuario.user.foto}` : `${URLBASE}/images/users/USUARIO_ICONO.png`}
                                            alt={`Foto de perfil de ADMIN ADMIN`}
                                            className="img-fluid"
                                            style={{ maxWidth: '300px', height: 'auto', borderRadius: '0.2rem' }}
                                        />
                                        <figcaption className="mt-3">
                                            <h3 style={{ fontWeight: 'bold' }}>{(usuario?.nombres && usuario?.apellidos)
                            ...
                            <article className="card-body p-4" aria-labelledby="detalles-personales-titulo">
                                ...
                                <div className="row pt-1">
                                    <section className="col-md-6 col-12 mb-3">
                                        ...
                                        <p
                                            aria-label={`Correo electrónico: yovin.urrego@unl.edu.ec`}
                                            className="text-break"
                                        >
                                          yovin.urrego@unl.edu.ec
                                        </p>
                                    </section>
                                    <section className="col-md-6 col-12 mb-3">
                                        <h3>Fecha de nacimiento</h3>
                                        <p aria-label={`Fecha de nacimiento: 2003-12-05`}>
                                ...
                                <div className="row pt-1">
                                    <section className="col-md-6 col-12 mb-3">
                                        ...
                                        <p aria-label={`Número de contacto: ${usuario?.user?.telefono || "0980735353"}`}>{usuario?.user?.telefono || "0980735353"}</p>
                                    </section>
                                </div>
                            </article>
                        </section>
